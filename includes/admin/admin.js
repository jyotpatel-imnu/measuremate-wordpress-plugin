document.addEventListener("DOMContentLoaded", function () {
  ...
  errorMessage.textContent =
    "To enable Enhanced Tracking v2, it is required to supply a Measuremate Container Identifier.";
  ...
  function validateForm() {
    if (
      enhancedTrackingCheckbox.checked &&
      containerIdField.value.trim() === ""
    ) {
